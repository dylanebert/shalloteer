...
export default [
  ...
  // Test files: can import from shalloteer package
  {
          ...
          patterns: [
            {
              group: ['*/src/*', '../src/*', '../../src/*'],
              message:
                'Tests should import from shalloteer package, not source files directly',
            },
          ],
        },
      ],
  ...
  // JavaScript files (for create-shalloteer script)
  {
    files: ['**/*.js'],
    languageOptions: {
      ecmaVersion: 'latest',
  ...
  {
    files: ['create-shalloteer/template/**/*'],
    rules: {
