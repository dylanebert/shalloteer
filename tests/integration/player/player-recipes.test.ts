...
import { State, XMLParser, parseXMLToEntities } from 'shalloteer';
import { RecipePlugin, createEntityFromRecipe } from 'shalloteer';
import {
  Player,
  PlayerPlugin,
  CharacterMovement,
...
import { Respawn, RespawnPlugin } from 'shalloteer';
