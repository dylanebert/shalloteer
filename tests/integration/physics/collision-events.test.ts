...
describe('Collision Events Integration', () => {
  ...
  it('should detect collision between dynamic bodies', () => {
    ...
    for (let i = 0; i < 60; i++) {
      ...
      const touchedEvents1 = state.query(TouchedEvent);
      const touchedEvents2 = state.query(TouchedEvent);
  ...
  it('should detect collision with static bodies', () => {
    ...
    for (let i = 0; i < 60; i++) {
      ...
      const touchedEvents = state.query(TouchedEvent);
  ...
  it('should detect collision end events', () => {
    ...
    for (let i = 0; i < 120; i++) {
      ...
      const touchedEvents = state.query(TouchedEvent);
      const touchEndedEvents = state.query(TouchEndedEvent);
