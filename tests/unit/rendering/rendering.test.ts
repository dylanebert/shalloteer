...
describe('Rendering Components', () => {
  ...
  it('should support component queries', () => {
    const rendererQuery = state.query(Renderer);
    const cameraQuery = state.query(MainCamera);
    const combinedQuery = state.query(Renderer, MainCamera);
  ...
  it('should support querying light components', () => {
    const ambientQuery = state.query(Ambient);
    const directionalQuery = state.query(Directional);
